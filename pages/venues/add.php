        ...
        <div class="container is-fluid">
          <div class="level mb-4">
            <div class="level-left">
              <div>
                <h1 class="title is-3 has-text-light"><?php echo $editVenue ? 'Edit Venue' : 'Add Venue'; ?></h1>
                <p class="subtitle is-6 has-text-grey-light">Manage venue details below.</p>
              </div>
            </div>
          </div>
          ...
          <?php if ($mapboxSearchNotice !== ''): ?>
            <div class="notification is-warning is-light"><?php echo htmlspecialchars($mapboxSearchNotice); ?></div>
          <?php endif; ?>
          ...
          <div class="box mb-4 has-background-dark has-text-light">
            <form method="GET" action="" class="columns is-multiline is-vcentered">
              <div class="column is-5">
                <label for="web_search" class="label has-text-light">Search the web</label>
                <div class="control has-icons-left">
                  <input type="text" id="web_search" name="web_search" class="input has-background-grey-darker has-text-light" placeholder="Search the web for venue info" value="<?php echo htmlspecialchars($webSearchQuery); ?>">
                  <span class="icon is-left"><i class="fa-solid fa-magnifying-glass"></i></span>
                </div>
              </div>
              <div class="column is-3">
                <label for="web_search_country" class="label has-text-light">Search country</label>
                <div class="control">
                  <div class="select is-fullwidth">
                    <select id="web_search_country" name="web_search_country" class="has-background-grey-darker has-text-light">
            ...
            <form method="POST" action="" class="columns is-multiline">
              ...
              <div class="column is-6">
                <div class="field">
                  ...
                  <div class="control">
                    <input type="text" id="name" name="name" class="input has-background-grey-darker has-text-light" required value="<?php echo htmlspecialchars($formValues['name']); ?>">
                  </div>
                </div>
              </div>
              <div class="column is-6">
                <div class="field">
                  <label for="type" class="label has-text-light">Type</label>
                  <div class="control">
                    <div class="select is-fullwidth">
                      <select id="type" name="type" class="has-background-grey-darker has-text-light">
              ...
              <div class="column is-4">
                <div class="field">
                  <label for="state" class="label has-text-light">State</label>
                  <div class="control">
                    <input type="text" id="state" name="state" class="input has-background-grey-darker has-text-light" value="<?php echo htmlspecialchars($formValues['state']); ?>">
                  </div>
                </div>
              </div>
              <div class="column is-4">
                <div class="field">
                  <label for="city" class="label has-text-light">City *</label>
                  <div class="control">
                    <input type="text" id="city" name="city" class="input has-background-grey-darker has-text-light" required value="<?php echo htmlspecialchars($formValues['city']); ?>">
                  </div>
                </div>
              </div>
              <div class="column is-4">
                <div class="field">
                  <label for="postal_code" class="label has-text-light">Postal Code</label>
                  <div class="control">
                    <input type="text" id="postal_code" name="postal_code" class="input has-background-grey-darker has-text-light" value="<?php echo htmlspecialchars($formValues['postal_code']); ?>">
                  </div>
                </div>
              </div>
              <div class="column is-4">
                <div class="field">
                  <label for="country" class="label has-text-light">Country</label>
                  <div class="control">
                    <div class="select is-fullwidth">
                      <select id="country" name="country" class="has-background-grey-darker has-text-light">
              ...
              <div class="column is-8">
                <div class="field">
                  <label for="address" class="label has-text-light">Address</label>
                  <div class="field has-addons">
                    <div class="control is-expanded">
                      <input type="text" id="address" name="address" class="input has-background-grey-darker has-text-light" value="<?php echo htmlspecialchars($formValues['address']); ?>">
                    </div>
                    <div class="control">
                      <button type="submit" form="mapbox_search_form" class="button is-info" id="address_mapbox_button" aria-label="Search address" disabled>
              ...
              <div class="column is-3">
                <div class="field">
                  <label for="latitude" class="label has-text-light">Latitude</label>
                  <div class="control">
                    <input type="number" step="0.000001" id="latitude" name="latitude" class="input has-background-grey-darker has-text-light" value="<?php echo htmlspecialchars($formValues['latitude']); ?>">
                  </div>
                </div>
              </div>
              <div class="column is-3">
                <div class="field">
                  <label for="longitude" class="label has-text-light">Longitude</label>
                  <div class="control">
                    <input type="number" step="0.000001" id="longitude" name="longitude" class="input has-background-grey-darker has-text-light" value="<?php echo htmlspecialchars($formValues['longitude']); ?>">
                  </div>
                </div>
              </div>
              <div class="column is-3">
                <div class="field">
                  <label for="capacity" class="label has-text-light">Capacity</label>
                  <div class="control">
                    <input type="number" step="1" id="capacity" name="capacity" class="input has-background-grey-darker has-text-light" value="<?php echo htmlspecialchars($formValues['capacity']); ?>">
                  </div>
                </div>
              </div>
              <div class="column is-6">
                <div class="field">
                  <label for="website" class="label has-text-light">Website</label>
                  <div class="control">
                    <input type="url" id="website" name="website" class="input has-background-grey-darker has-text-light" value="<?php echo htmlspecialchars($formValues['website']); ?>">
                  </div>
                </div>
              </div>
              <div class="column is-6">
                <div class="field">
                  <label for="contact_email" class="label has-text-light">Contact Email</label>
                  <div class="control">
                    <input type="email" id="contact_email" name="contact_email" class="input has-background-grey-darker has-text-light" value="<?php echo htmlspecialchars($formValues['contact_email']); ?>">
                  </div>
                </div>
              </div>
              <div class="column is-6">
                <div class="field">
                  <label for="contact_phone" class="label has-text-light">Contact Phone</label>
                  <div class="control">
                    <input type="text" id="contact_phone" name="contact_phone" class="input has-background-grey-darker has-text-light" value="<?php echo htmlspecialchars($formValues['contact_phone']); ?>">
                  </div>
                </div>
              </div>
              <div class="column is-6">
                <div class="field">
                  <label for="contact_person" class="label has-text-light">Contact Person</label>
                  <div class="control">
                    <input type="text" id="contact_person" name="contact_person" class="input has-background-grey-darker has-text-light" value="<?php echo htmlspecialchars($formValues['contact_person']); ?>">
                  </div>
                </div>
              </div>
              <div class="column is-12">
                <div class="field">
                  <label for="notes" class="label has-text-light">Notes</label>
                  <div class="control">
                    <textarea id="notes" name="notes" class="textarea has-background-grey-darker has-text-light" rows="4"><?php echo htmlspecialchars($formValues['notes']); ?></textarea>
                  </div>
                </div>
              </div>
              ...
              <div class="column is-12">
                <div class="buttons">
                  <button type="submit" class="button is-link"><?php echo $editVenue ? 'Update Venue' : 'Add Venue'; ?></button>
                  <a href="<?php echo BASE_PATH; ?>/pages/venues/index.php" class="button is-light">Cancel</a>
                </div>
              </div>
            </form>
          </div>
