...
<div class="tab-panel <?php echo $activeTab === 'templates' ? '' : 'is-hidden'; ?>" data-tab-panel="templates" role="tabpanel">
  ...
  <div class="level mb-4">
    ...
    <div class="level-right">
      <a href="<?php echo BASE_PATH; ?>/app/pages/team/template_form.php" class="button is-primary">Add Template</a>
    </div>
  </div>
              ...
              <tr>
                ...
                <td>
                  <div class="buttons are-small">
                    <a href="<?php echo BASE_PATH; ?>/app/pages/team/template_form.php?edit_template_id=<?php echo (int) $template['id']; ?>" class="button" aria-label="Edit template" title="Edit template">
                      <span class="icon"><i class="fa-solid fa-pen"></i></span>
                    </a>
                    <form method="POST" action="<?php echo BASE_PATH; ?>/app/pages/team/index.php?tab=templates" onsubmit="return confirm('Delete this template?');">
                      <?php renderCsrfField(); ?>
